...
static const NSString *rsaStr = @"";
static const NSString *appID = @"2016110102466751";

@implementation Order (Producer)
...
//    NSString *appID = @"";
    ...
    NSString *rsa2PrivateKey = rsaStr;
    ...
    order.biz_content.out_trade_no = outTradeNo; //订单ID（由商家自行制定）
    order.biz_content.timeout_express = @"30m"; //超时时间设置
    order.biz_content.total_amount = [NSString stringWithFormat:@"%.2f", totalAmount]; //商品价格
